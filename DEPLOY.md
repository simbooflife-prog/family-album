...
3. Bump every Lovelace iframe `?v=` (Overview + digital-frame). Suggested next: match `FRAME_BUILD` (currently `20260912-ui12`).
...
- Example: `/local/family-album/frame.html?v=20260912-ui12`
